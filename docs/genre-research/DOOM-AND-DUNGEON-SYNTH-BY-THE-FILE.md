...
| 3 | `scales: minor 4, dorian 3, phrygian 1` | Burzum phrygian 5 dorian 3 minor 0; Mortiis aeolian 7 phrygian 6; doom phrygian 15 of 30 | **APPLIED IN PART.** Phrygian is 3, level with dorian. And the flat second has a chord to stand on: the one progression that carried it, `[1, 4, 1, 4]`, pairs it with the fifth degree, which is diminished in phrygian, so `harmony.diminished: "avoid"` removed it and a phrygian record never stated its own mode (seed 274106: Em C Em Dm). The Andalusian cadence i–iv–III–bII is in the A pool and a bII–i vamp in B; over 60 seeds phrygian records went 14 → 23 and those stating the flat second 0 → 11. NOT applied: the held layer sitting on the flat second — `drone.tone` is still tonic or fifth |
